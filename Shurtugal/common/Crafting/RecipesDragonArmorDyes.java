...
public class RecipesDragonArmorDyes implements IRecipe
{
	/**
	...
	public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
	{
		...
		for (int var5 = 0; var5 < par1InventoryCrafting.getSizeInventory(); ++var5)
		{
			...
			if (var6 != null)
			{
				if (var6.getItem() instanceof ItemDragonArmor)
				{
					ItemDragonArmor var7 = (ItemDragonArmor) var6.getItem();
	...
	public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
	{
		...
		for (var7 = 0; var7 < par1InventoryCrafting.getSizeInventory(); ++var7)
		{
			...
			if (var8 != null)
			{
				if (var8.getItem() instanceof ItemDragonArmor)
				{
					var6 = (ItemDragonArmor) var8.getItem();
