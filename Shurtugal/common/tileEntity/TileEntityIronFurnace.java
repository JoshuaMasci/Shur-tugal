...
import Shurtugal.common.IronFurnace.IronFurnaceRecipes;
import Shurtugal.common.block.BlockIronFurnace;

public class TileEntityIronFurnace extends TileEntity implements IInventory, ISidedInventory
{
	...
	private int getCookTime()
	{
		...
		if (furnaceItemStacks[0].itemID == ShurtugalMod.blockHandler.brightSteelOre.blockID)
		{
			return 250;
		}
		else if (furnaceItemStacks[0].itemID == Item.ingotIron.itemID)
		{
			return 200;
		}
		else
	...
	public void updateEntity()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				var2 = true;
				BlockIronFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack var1 = IronFurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
			if (var1 == null)
				return false;
	...
	public void smeltItem()
	{
		if (this.canSmelt())
		{
			...
			var1 = IronFurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
