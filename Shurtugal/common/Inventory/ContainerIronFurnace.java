package Shurtugal.common.Inventory;
...
public class ContainerIronFurnace extends Container
{
	...
	public ContainerIronFurnace(InventoryPlayer par1InventoryPlayer, TileEntityIronFurnace par2TileEntityFurnace)
	{
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
	{
		...
		if (var4 != null && var4.getHasStack())
		{
			...
			{
				if (IronFurnaceRecipes.smelting().getSmeltingResult(var5) != null)
				{
				...
				else if (TileEntityIronFurnace.isItemFuel(var5))
				{
