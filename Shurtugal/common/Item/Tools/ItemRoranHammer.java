...
public class ItemRoranHammer extends Item
{
	private int weaponDamage;
	public ItemRoranHammer(int par1)
	{
	super(par1);
	...
	{
		this.itemIcon = par1IconRegister.registerIcon("shurtugal:roranhammer");
	}
	 ...
	 public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	    {
	        ...
	        else
	        {
	            ...
	            if ((par7 == 0 || j1 != 0 || i1 != Block.anvil.blockID))
	            {
	                return false;
	            }
	            else
